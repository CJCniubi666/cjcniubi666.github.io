import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,e as s}from"./app-eb0bb6b3.js";const d={},l=s(`<h1 id="php魔术方法" tabindex="-1"><a class="header-anchor" href="#php魔术方法" aria-hidden="true">#</a> php魔术方法</h1><h2 id="construct-——构造方法" tabindex="-1"><a class="header-anchor" href="#construct-——构造方法" aria-hidden="true">#</a> __construct()——构造方法</h2><p>触发条件：在对象实例化的时候自动触发</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>red  
&lt;?php  
