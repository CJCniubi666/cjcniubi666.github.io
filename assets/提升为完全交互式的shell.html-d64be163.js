import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as n,e}from"./app-d9e8e259.js";const t={},p=e(`<h2 id="有python" tabindex="-1"><a class="header-anchor" href="#有python" aria-hidden="true">#</a> 有python</h2><h2 id="python" tabindex="-1"><a class="header-anchor" href="#python" aria-hidden="true">#</a> Python</h2><p>提升为完全交互式终端</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#检测python版本</span>
