import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as s,e as d}from"./app-d0e767d0.js";const n={},a=d(`<h1 id="hfish的搭建-docker" tabindex="-1"><a class="header-anchor" href="#hfish的搭建-docker" aria-hidden="true">#</a> HFish的搭建（docker）</h1><p>首先下载小皮面板启动<code>mysql</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>phpstudy -start
phpstudy -h
//可查看帮助
